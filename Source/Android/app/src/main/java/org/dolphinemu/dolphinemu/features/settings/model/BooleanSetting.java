...
public enum BooleanSetting implements AbstractBooleanSetting
{
  ...
  MAIN_BUTTON_TOGGLE_GC_11(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGCTriggerLANALOG", true),
  MAIN_BUTTON_TOGGLE_GC_12(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGCTriggerRANALOG", true),
